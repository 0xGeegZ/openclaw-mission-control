...
- After runOnePollCycle: first notification should have markNotificationDeliveryEnded called (and not markNotificationDelivered); second should be marked delivered. State.failedCount should be 1, deliveredCount 1.
