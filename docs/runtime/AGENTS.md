...
- **document_list** — List documents in the account or for a task (optional taskId, type, limit). Use to discover existing deliverables, notes, templates, or references before creating or updating. Available when you can create documents or when you have task context.
