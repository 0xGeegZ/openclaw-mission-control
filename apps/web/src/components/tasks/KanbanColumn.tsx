...
import { Plus, Inbox, CheckCircle2, Clock, Eye, AlertTriangle, Users, Archive } from "lucide-react";
        ...
        {tasks.length === 0 && (
          <div className="flex flex-col items-center justify-center text-center py-12">
            <div className={cn(
              ...
              <StatusIcon className={cn("h-6 w-6", config.color, "opacity-50")} />
            </div>
            <p className="text-sm font-medium text-muted-foreground/70">No tasks</p>
            <p className="text-xs text-muted-foreground/50 mt-0.5">Drag tasks here</p>
          </div>
        )}
      </div>
    </div>
