...
> = {
  online: { color: "bg-emerald-500", pulseColor: "bg-emerald-400", label: "Online", variant: "default" },
  busy: { color: "bg-amber-500", pulseColor: "bg-amber-400", label: "Busy", variant: "secondary" },
  idle: {
    color: "bg-slate-400",
  ...
  error: { color: "bg-destructive", pulseColor: "bg-destructive/70", label: "Error", variant: "destructive" },
};
    ...
    <Link href={`/${accountSlug}/agents/${agent._id}`}>
      <Card className={cn(
        ...
        <div className={cn(
          ...
          isActive ? "bg-gradient-to-r from-emerald-500/80 to-emerald-400/40" : "bg-gradient-to-r from-muted-foreground/20 to-transparent"
        )} />
              ...
              <div className="flex items-center gap-2 mt-2">
                <Badge 
                  ...
                  className={cn(
                    ...
                    status.variant === "default" && "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20",
                    status.variant === "secondary" && "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20"
                  )}
                >
